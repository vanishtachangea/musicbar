...
var App = /*#__PURE__*/function (_Component) {
  ...
  function App() {
    ...
    _defineProperty(_assertThisInitialized(_this), "searchArtist", function (artistQuery) {
      var response = fetch("".concat(API_URL, "/artist/").concat(artistQuery)).then(function (res) {
        return res.json();
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("h2", null, " Music Bar"), /*#__PURE__*/_react.default.createElement(_Search.default, {
